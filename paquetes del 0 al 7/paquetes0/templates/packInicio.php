  ...
  <scene ID="verVariables" visible="1" pos="0 0">
    ...
    <group ID="btnsContratar" visible="1" pos="0 0">
        ...
        <imageButton ID="fox" visible="1" pos="110 230">
            <stateDef type="NORMAL" ref="<?php echo $this->serverPath; ?>img/fox_premium_bold_90x60.png" />
            <stateDef type="FOCUSED" ref="<?php echo $this->serverPath; ?>img/fox_premium_bold_90x60.png" />
            <stateDef type="SELECTED" actionList="{temp}" ref="<?php echo $this->serverPath; ?>img/fox_premium_bold_90x60.png" />
        </imageButton>
        <imageButton ID="futbol" visible="1" pos="230 230">
            <stateDef type="NORMAL" ref="<?php echo $this->serverPath; ?>img/futbol_fox_tnt_90x60.jpg" />
            <stateDef type="FOCUSED" ref="<?php echo $this->serverPath; ?>img/futbol_fox_tnt_90x60.jpg" />
            <stateDef type="SELECTED" actionList="{temp}" ref="<?php echo $this->serverPath; ?>img/futbol_fox_tnt_90x60.jpg" />
        </imageButton>
        <imageButton ID="adultos" visible="1" pos="440 230">
            <stateDef type="NORMAL" ref="<?php echo $this->serverPath; ?>img/adultos_plus18_90x60.png" />
            <stateDef type="FOCUSED" ref="<?php echo $this->serverPath; ?>img/adultos_plus18_90x60.png" />
            <stateDef type="SELECTED" actionList="{temp}" ref="<?php echo $this->serverPath; ?>img/adultos_plus18_90x60.png" />
        </imageButton>
