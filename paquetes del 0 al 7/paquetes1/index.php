<?php
    ...
    class Packs
    {
      ...
      function __construct()
      {
          ...
          $this->_servs_a_contratar = array('fox' => 782, 'futbolHD' => 1007, 'futbolSD' => 1026, 'adultos' => 566);
      ...
      private function _cargaVarConfig()
      {
        ...
        public function correr()
        {
            ...
            //$this->clientMAC = '0002025C3A91';     // Grossi Catalina - 168164 - Servicios Basicos
            //$this->clientMAC = '0002025E0918';     // Rossi Ezio -  171036  - Tiene Pack Futbol
        ...
        private function _verServsClie($custId)
        {
            ...
            if ($arrServicios[0] != "Vacio") {
                ...
                foreach ($arrServicios as $value) {
                    switch ($value) {
                      case $this->_servs_a_contratar['fox']:
                        $this->_foxContratado = true;
                        break;
                      case $this->_servs_a_contratar['futbolHD'] || $this->_servs_a_contratar['futbolSD']:
                        $this->_futbolContratado = true;
                        break;
                      case $this->_servs_a_contratar['adultos']:
