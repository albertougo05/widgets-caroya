<sdm>
  ...
  <scene ID="selecServ" visible="1" pos="0 0">
    ...
    <group ID="inputs" visible="1" pos="0 0">
        ...
        <textEdit ID="inputPrest" visible="1" rect="70 360 100 35" text="" fontID="18" foreColor="0xFFFFFFFF" maxlen="10" password="0" border="5" focus="0" />
        ...
        <textEdit ID="confirmAdultos" visible="0" rect="5 5 100 35" text="confirmAdultos" fontID="16" foreColor="0xFFFFFFFF" maxlen="10" password="0" border="5" focus="0" />
