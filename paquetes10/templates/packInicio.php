<sdm>
  ...
  <scene ID="verVariables" visible="1" pos="0 0">
    ...
    <image ID="packs_bkg" visible="1" pos="35 70" ref="<?php echo $this->serverPath; ?>img/paquetes_bkg.png" cache="1" />
    ...
    <group ID="btnsContratar" visible="1" pos="0 0">
      ...
      <?php if($this->_foxContratado) {?>
        ...
        <image ID="fox_contratado" visible="1" pos="110 225" ref="<?php echo $this->serverPath; ?>img/fox_premium_contrat.png" cache="1" />

      <?php } else {?>
        <imageButton ID="btnFox" visible="1" pos="110 225">
            <stateDef type="NORMAL" ref="<?php echo $this->serverPath; ?>img/fox_premium.png" />
            <stateDef type="FOCUSED" ref="<?php echo $this->serverPath; ?>img/fox_premium_focused3.png" />
      ...
      <?php if($this->_futbolContratado) {?>
        ...
        <image ID="futbol_contratado" visible="1" pos="230 225" ref="<?php echo $this->serverPath; ?>img/futbol_fox_tnt_contrat.png" cache="1" />

     <?php } else {?>
        <imageButton ID="btnFutbol" visible="1" pos="230 225">
            <stateDef type="NORMAL" ref="<?php echo $this->serverPath; ?>img/futbol_fox_tnt.jpg" />
            <stateDef type="FOCUSED" ref="<?php echo $this->serverPath; ?>img/futbol_fox_tnt_focused3.png" />
      ...
      <?php if($this->_adultosContratado) {?>
        ...
        <image ID="adulto_contratado" visible="1" pos="440 225" ref="<?php echo $this->serverPath; ?>img/adultos_contrat.png" cache="1" />

     <?php } else {?>
        <imageButton ID="btnAdulto" visible="1" pos="440 225">
            <stateDef type="NORMAL" ref="<?php echo $this->serverPath; ?>img/adultos_90x60.png" />
            <stateDef type="FOCUSED" ref="<?php echo $this->serverPath; ?>img/adultos_focused3.png" />
    ...
    <define>
      ...
      <moduleMsg ID="quiereFox" message="&amp;selec=fox&amp;tieneHD=<?php echo $this->_tieneHD; ?>&amp;nroPrest=<?php echo $this->_nroPrest; ?>" />
      <moduleMsg ID="quiereFut" message="&amp;selec=futbol&amp;tieneHD=<?php echo $this->_tieneHD; ?>&amp;nroPrest=<?php echo $this->_nroPrest; ?>" />
      <moduleMsg ID="quiereAdu" message="&amp;selec=adulto&amp;tieneHD=<?php echo $this->_tieneHD; ?>&amp;nroPrest=<?php echo $this->_nroPrest; ?>" />
