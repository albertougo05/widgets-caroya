<?php
    ...
    class Packs
    {
        ...
        function __construct()
        {
            ...
            $this->_arrPreciosPacks = $this->_getPrecios();
        ...
        /**
         * Obtener precios desde alberto.coop5.com.ar
         *
         */
        private function _getPrecios()
        {
            $strConn = "http://alberto.coop5.com.ar/data/preciosPacks.php";
            $jsonData = file_get_contents($strConn);
            $arrPrecios = json_decode($jsonData, true);
...
//            } else include './templates/errorCargaServ.php';
        ...
        private function _cargarServicioEnSistCoop($selec)
        {
            ...
            $idUsuario = "45";
            $token = "32f950c51e3c3538908828a2ff024339";
            $datosArr = array('idAccion' => 'CobrarServicioAdicionalIptv', 'idPrestacion' => "$this->_nroPrest", 'idAcceso' => '99999', 'idAdicionalIptv' => "$codSistema");
            $datosJson = json_encode($datosArr);
            $strConn = "http://isp.coop5.com.ar/api.php?idUsuario=$idUsuario&";
            $strConn = $strConn."token=$token&";
            $strConn = $strConn."datos=$datosJson";

            $jsonData = file_get_contents($strConn);
            $respAddServ = json_decode($jsonData, true);

    include './templates/verVar3.php';
        ...
        private function _grabarLogAccess()
        {
            ...
            $texto = $texto." - AccountID: ".$this->accountID." - Prestacion: ".$this->_nroPrest;;
