<sdm>
    ...
    <scene ID="selecServ" visible="1" pos="0 0">
        ...
        <group ID="imagPack" visible="1" pos="0 0">
            ...
            <?php if($selecciono == 'adulto') {?>
                ...
                <textRect ID="titCondicAdu" visible="1" rect="200 290 500 40" fontID="18" foreColor="0xFFFFFFFF" horzJust="LEFT" vertJust="CENTER">
                    <text><![CDATA[Su grilla agrega canales 700, 701 y 702]]></text>
                </textRect>
            <?php }?>
        ...
        <group ID="botones" visible="1" pos="0 0">
            ...
            <textButton ID="btnContinuar" visible="1" rect="310 360 110 35" text="Continuar" fontID="18" foreColor="0xFFFFFFFF">
                <stateDef type="SELECTED" actionList="{resetStb}" />  <!-- Debe ser resetStb -->
            </textButton>
    ...
    <define>
        ...
        <moduleMsg ID="resetStb" message="&amp;resetStb=resetStb&amp;nroPrest=<?php echo $this->_nroPrest; ?>" />
