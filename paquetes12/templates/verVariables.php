<sdm>
  ...
  <scene ID="verVariables" visible="1" pos="0 0">
    ...
    <image ID="packs_bkg" visible="1" pos="30 70" ref="<?php echo $this->serverPath; ?>img/paquetes_bkg.png" cache="1" />
    ...
    <group ID="textoNoResult" visible="1" pos="0 0">
      ...
      <textRect ID="dato62" visible="1" rect="110 360 600 40" fontID="18" foreColor="0xFFFFFFFF" horzJust="LEFT" vertJust="CENTER">
        <text><![CDATA[Tiene HD: <?php echo ($this->_tieneHD) ? "SI": "NO"; ?>]]></text>
      </textRect>
